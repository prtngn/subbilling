...
<tr align="center">
	...
	{if not($level or $id_group)}
	<td class="{$classname}" width="22"><a href="stats.php?min1={$stats[stat].i}&amp;hour1={$stats[stat].G}&amp;day1={$stats[stat].j}&amp;month1={$stats[stat].n}&amp;year1={$stats[stat].Y}&amp;min2={$stats[stat].i}&amp;hour2={$stats[stat].G}&amp;day2={$stats[stat].j}&amp;month2={$stats[stat].n}&amp;year2={$stats[stat].Y}&amp;type={$type}&amp;level=1"><img src="templates/img/zones.png" alt="{$lang.stats_zonelevel}" title="{$lang.stats_zonelevel}"></a></td>
	{/if}
</tr>
