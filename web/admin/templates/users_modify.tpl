...
<tr align="left">
	...
	<td><input type="text" name="eth_mac_0" value="{if $eth_mac_0}{$eth_mac_0}{else}00{/if}" size="2"><input type="text" name="eth_mac_1" value="{if $eth_mac_1}{$eth_mac_1}{else}00{/if}" size="2"><input type="text" name="eth_mac_2" value="{if $eth_mac_2}{$eth_mac_2}{else}00{/if}" size="2"><input type="text" name="eth_mac_3" value="{if $eth_mac_3}{$eth_mac_3}{else}00{/if}" size="2"><input type="text" name="eth_mac_4" value="{if $eth_mac_4}{$eth_mac_4}{else}00{/if}" size="2"><input type="text" name="eth_mac_5" value="{if $eth_mac_5}{$eth_mac_5}{else}00{/if}" size="2"></td>
</tr>
</tr>
<tr align="left">
